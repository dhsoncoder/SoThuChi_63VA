...
public class PLChitieuMoiActivity extends AppCompatActivity {
    ...
    private EditText edtChiTieuPLMoi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gridViewDemo.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                imgChiTieuMoi.setImageResource(selectedImageRes);
    ...
    private void themPLChiTieu() {
        // Lấy tên danh mục nhập vào
        edtChiTieuPLMoi = findViewById(R.id.edtchitieuPLmoi);
        String tenDanhMuc = edtChiTieuPLMoi.getText().toString().trim();

        // Kiểm tra nếu tên danh mục không trống
        if (tenDanhMuc.isEmpty()) {
            edtChiTieuPLMoi.setError("Vui lòng nhập tên danh mục");
            edtChiTieuPLMoi.requestFocus();
            return;
        }
        ...
        values.put(DatabaseHelper.COLUMN_LOAI, 0); // loai = 0
