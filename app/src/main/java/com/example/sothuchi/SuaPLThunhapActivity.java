...
public class SuaPLThunhapActivity extends AppCompatActivity {
    ...
    private ImageView imgThuNhap;
    private CardView cardviewcolor;
    private EditText edtThuNhapPL;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sua_plthunhap);

        // Initialize views
        gridViewDemo = findViewById(R.id.gridviewthunhap);
        imgThuNhap = findViewById(R.id.imgthunhap);
        cardviewcolor = findViewById(R.id.cardviewcolor);
        btnDoiMau = findViewById(R.id.btndoimau);
        edtThuNhapPL = findViewById(R.id.edtthunhapPL);
        arrimage = new ArrayList<>();
        adapterDanhSach = new MyarrayAdapter(SuaPLThunhapActivity.this, R.layout.listicon, arrimage);
        ...
        if (extras != null) {
            ...
            imgThuNhap.setImageResource(bieuTuong);
            edtThuNhapPL.setText(tenDanhMuc);
        ...
        gridViewDemo.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                imgThuNhap.setImageResource(selectedImageRes);
    ...
    private void capNhatDanhMuc() {
        String tenDanhMucMoi = edtThuNhapPL.getText().toString().trim();

        // Kiểm tra nếu tên danh mục không trống
        if (tenDanhMucMoi.isEmpty()) {
            edtThuNhapPL.setError("Vui lòng nhập tên danh mục");
            edtThuNhapPL.requestFocus();
            return;
        }
        ...
        if (rowsAffected > 0) {
            Toast.makeText(SuaPLThunhapActivity.this, "Đã cập nhật danh mục thành công", Toast.LENGTH_SHORT).show();
            finish(); // Đóng Activity sau khi cập nhật thành công
        } else {
            Toast.makeText(SuaPLThunhapActivity.this, "Cập nhật danh mục thất bại", Toast.LENGTH_SHORT).show();
        }
    }
